    ...
    <div class="container">
      ...
      <div class="resource-grid">
        @forelse($resources as $resource)
          <a href="{{ $resource->pdf_path ? asset($resource->pdf_path) : 'javascript:void(0);' }}" 
             @if($resource->pdf_path) target="_blank" download @endif 
             class="resource-card">
            <div class="resource-icon">
              ...
              @elseif($resource->image_path)
                <img src="{{ asset($resource->image_path) }}" alt="" style="width: 28px; height: 28px; object-fit: contain;">
              @else
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="download-link">
              {{ $resource->link_text ?: 'Download PDF' }}
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
